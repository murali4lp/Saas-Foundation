...
ADMINS = [(config("ADMIN_USER_NAME", cast=str, default="test_user"), config("ADMIN_USER_EMAIL", cast=str))]
MANAGERS = ADMINS
...
# Uncomment the below part when you have a separate DB instead of the default 
